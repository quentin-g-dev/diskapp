...
{
    private $valueHolder1afa7 = null;
    private $initializerda1d6 = null;
    private static $publicPropertiesed0ad = [
        
    ];
    public function getConnection()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getConnection', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getMetadataFactory', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getExpressionBuilder', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'beginTransaction', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->beginTransaction();
    }
    public function getCache()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getCache', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getCache();
    }
    public function transactional($func)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'transactional', array('func' => $func), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->transactional($func);
    }
    public function commit()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'commit', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->commit();
    }
    public function rollback()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'rollback', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getClassMetadata', array('className' => $className), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'createQuery', array('dql' => $dql), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'createNamedQuery', array('name' => $name), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'createQueryBuilder', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'flush', array('entity' => $entity), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->flush($entity);
    }
    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->find($className, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'clear', array('entityName' => $entityName), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->clear($entityName);
    }
    public function close()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'close', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->close();
    }
    public function persist($entity)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'persist', array('entity' => $entity), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'remove', array('entity' => $entity), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'refresh', array('entity' => $entity), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'detach', array('entity' => $entity), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'merge', array('entity' => $entity), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getRepository', array('entityName' => $entityName), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'contains', array('entity' => $entity), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getEventManager', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getConfiguration', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'isOpen', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getUnitOfWork', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getProxyFactory', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'initializeObject', array('obj' => $obj), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'getFilters', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'isFiltersStateClean', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'hasFilters', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return $this->valueHolder1afa7->hasFilters();
    }
    ...
    {
        static $reflection;
        if (! $this->valueHolder1afa7) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder1afa7 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        }, $this, 'Doctrine\\ORM\\EntityManager')->__invoke($this);
        }
        $this->valueHolder1afa7->__construct($conn, $config, $eventManager);
    }
    public function & __get($name)
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, '__get', ['name' => $name], $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        if (isset(self::$publicPropertiesed0ad[$name])) {
            return $this->valueHolder1afa7->$name;
        }
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder1afa7;
    ...
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder1afa7;
    ...
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, '__isset', array('name' => $name), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder1afa7;
    ...
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, '__unset', array('name' => $name), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder1afa7;
    ...
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, '__clone', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        $this->valueHolder1afa7 = clone $this->valueHolder1afa7;
    }
    public function __sleep()
    {
        $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, '__sleep', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
        return array('valueHolder1afa7');
    }
    ...
    {
        return $this->initializerda1d6 && ($this->initializerda1d6->__invoke($valueHolder1afa7, $this, 'initializeProxy', array(), $this->initializerda1d6) || 1) && $this->valueHolder1afa7 = $valueHolder1afa7;
    }
    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder1afa7;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder1afa7;
    }
}

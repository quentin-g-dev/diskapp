...
class srcApp_KernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Vh--4MZGQc', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jTyFSHsrNZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2zb6D4Prdo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('do81hlM0DF', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IW5PoqpqzT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1s0vtEV9Ff', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Vk35dQzJ5n', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('i9V-bpFIxu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NwKB-vTqqZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('d51x5qvnkr', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('w51n5WLV4N', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
...
{
    private $valueHolder409fa = null;
    private $initializer1084e = null;
    private static $publicProperties75740 = [
        
    ];
    public function getConnection()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getConnection', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getMetadataFactory', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getExpressionBuilder', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'beginTransaction', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getCache', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getCache();
    }
    public function transactional($func)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'transactional', array('func' => $func), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->transactional($func);
    }
    public function commit()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'commit', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->commit();
    }
    public function rollback()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'rollback', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getClassMetadata', array('className' => $className), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'createQuery', array('dql' => $dql), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'createNamedQuery', array('name' => $name), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'createQueryBuilder', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'flush', array('entity' => $entity), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->flush($entity);
    }
    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->find($className, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'clear', array('entityName' => $entityName), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->clear($entityName);
    }
    public function close()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'close', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->close();
    }
    public function persist($entity)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'persist', array('entity' => $entity), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'remove', array('entity' => $entity), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'refresh', array('entity' => $entity), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'detach', array('entity' => $entity), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'merge', array('entity' => $entity), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getRepository', array('entityName' => $entityName), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'contains', array('entity' => $entity), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getEventManager', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getConfiguration', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'isOpen', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getUnitOfWork', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getProxyFactory', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'initializeObject', array('obj' => $obj), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'getFilters', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'isFiltersStateClean', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'hasFilters', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return $this->valueHolder409fa->hasFilters();
    }
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer1084e = $initializer;
        return $instance;
    }
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        static $reflection;
        if (! $this->valueHolder409fa) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder409fa = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        }, $this, 'Doctrine\\ORM\\EntityManager')->__invoke($this);
        }
        $this->valueHolder409fa->__construct($conn, $config, $eventManager);
    }
    public function & __get($name)
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, '__get', ['name' => $name], $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        if (isset(self::$publicProperties75740[$name])) {
            return $this->valueHolder409fa->$name;
        }
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder409fa;
    ...
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder409fa;
    ...
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, '__isset', array('name' => $name), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder409fa;
    ...
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, '__unset', array('name' => $name), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder409fa;
    ...
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, '__clone', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        $this->valueHolder409fa = clone $this->valueHolder409fa;
    }
    public function __sleep()
    {
        $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, '__sleep', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
        return array('valueHolder409fa');
    }
    ...
    {
        $this->initializer1084e = $initializer;
    }
    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer1084e;
    }
    public function initializeProxy() : bool
    {
        return $this->initializer1084e && ($this->initializer1084e->__invoke($valueHolder409fa, $this, 'initializeProxy', array(), $this->initializer1084e) || 1) && $this->valueHolder409fa = $valueHolder409fa;
    }
    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder409fa;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder409fa;
    }
}

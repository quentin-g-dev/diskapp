...
class __TwigTemplate_7ce19906b05e35f6fd011ff731ab06059684a439f71eeb92d715eb1971b26b6d extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 15
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 15, $this->source); })()), 'form_end');
        echo "
";
    ...
    {
        return array (  116 => 15,  109 => 11,  105 => 10,  101 => 8,  92 => 7,  87 => 6,  77 => 5,  59 => 3,  36 => 1,);
    }

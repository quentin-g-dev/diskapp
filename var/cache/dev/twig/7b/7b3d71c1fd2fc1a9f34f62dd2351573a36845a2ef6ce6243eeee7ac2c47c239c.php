...
class __TwigTemplate_b9d73edc00324bb4e128b1792a918c105ca2f738823dea9e59dec28050260030 extends Template
{
    ...
    <a href=\"/productions/set/";
        // line 8
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["production"]) || array_key_exists("production", $context) ? $context["production"] : (function () { throw new RuntimeError('Variable "production" does not exist.', 8, $this->source); })()), "id", [], "any", false, false, false, 8), "html", null, true);
        echo "\" class=\"btn btn-info text-white ml-3\">Modifier</a>
    <button  class=\"btn btn-danger text-white ml-3\" onclick=\"deleteProduction(";
        // line 9
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["production"]) || array_key_exists("production", $context) ? $context["production"] : (function () { throw new RuntimeError('Variable "production" does not exist.', 9, $this->source); })()), "id", [], "any", false, false, false, 9), "html", null, true);
...
";
    ...
    public function block_custom_scripts($context, array $blocks = [])
    {
        ...
        echo "<script src=\"";
        echo twig_escape_filter($this->env, (isset($context["script"]) || array_key_exists("script", $context) ? $context["script"] : (function () { throw new RuntimeError('Variable "script" does not exist.', 40, $this->source); })()), "html", null, true);
        echo "\"></script>";
    ...
    {
        return array (  176 => 40,  164 => 36,  155 => 33,  151 => 32,  145 => 31,  141 => 30,  135 => 29,  129 => 28,  125 => 27,  122 => 26,  118 => 25,  99 => 9,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  60 => 3,  37 => 1,);
    }

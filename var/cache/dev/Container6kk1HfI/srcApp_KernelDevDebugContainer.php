...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('E3b+4SJQn2', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KafiE3nD1b', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mudEomk1FH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HOrPkcrb33', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qMxv-aml3c', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kt1O8xF1fz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MAfucNgtgU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderf70e2 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerd60bf = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties163a3 = [
        
    ];

    public function getConnection()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getConnection', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getMetadataFactory', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getExpressionBuilder', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'beginTransaction', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getCache', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getCache();
    }

    public function transactional($func)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'transactional', array('func' => $func), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->transactional($func);
    }

    public function commit()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'commit', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->commit();
    }

    public function rollback()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'rollback', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getClassMetadata', array('className' => $className), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'createQuery', array('dql' => $dql), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'createNamedQuery', array('name' => $name), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'createQueryBuilder', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'flush', array('entity' => $entity), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'clear', array('entityName' => $entityName), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->clear($entityName);
    }

    public function close()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'close', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->close();
    }

    public function persist($entity)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'persist', array('entity' => $entity), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'remove', array('entity' => $entity), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'refresh', array('entity' => $entity), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'detach', array('entity' => $entity), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'merge', array('entity' => $entity), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getRepository', array('entityName' => $entityName), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'contains', array('entity' => $entity), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getEventManager', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getConfiguration', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'isOpen', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getUnitOfWork', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getProxyFactory', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'initializeObject', array('obj' => $obj), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'getFilters', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'isFiltersStateClean', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'hasFilters', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return $this->valueHolderf70e2->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerd60bf = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderf70e2) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderf70e2 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderf70e2->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, '__get', ['name' => $name], $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        if (isset(self::$publicProperties163a3[$name])) {
            return $this->valueHolderf70e2->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderf70e2;
    ...
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;
    ...
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, '__isset', array('name' => $name), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;
    ...
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, '__unset', array('name' => $name), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;
    ...
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, '__clone', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        $this->valueHolderf70e2 = clone $this->valueHolderf70e2;
    }

    public function __sleep()
    {
        $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, '__sleep', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;

        return array('valueHolderf70e2');
    }
    ...
    {
        $this->initializerd60bf = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerd60bf;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerd60bf && ($this->initializerd60bf->__invoke($valueHolderf70e2, $this, 'initializeProxy', array(), $this->initializerd60bf) || 1) && $this->valueHolderf70e2 = $valueHolderf70e2;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderf70e2;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderf70e2;
    }
}
